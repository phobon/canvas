...
import '../../.storybook/mockNextRouter';
import ConsultationList from './ConsultationList';

export default {
  component: ConsultationList,
  title: 'Components/ConsultationList',
};
...
const incomplete = {
  id: '515ab83e-2e8e-424e-badd-fe212c984d95',
  scheduled: '2020-01-02',
  lastSaved: '2019-12-28',
  completed: null,
  isComplete: false,
...
const consultations = [complete, incomplete];
...
export const withDifferentCompletionStates = () => (
  <Box width={350} height={600}>
    <ConsultationList
      ...
      remaining={2}
      selectedConsultation={consultations[1]} />
  </Box>
);